...
*The top-left corner carries the CTI logo (white version, from cowork/career-intelligence/week5/deck-src/cti-logo-white.png).*
...
**Lede (bold, above the graph):** Human value will grow as AI capability grows if students learn to think with AI and use it strategically.
...
**Step text:**
The human-led practice of pursuing wisdom in partnership with other intelligences, human or artificial.

**Step label:** Which builds three inter-related capabilities

*Figure: CTI's Symbiotic Thinking cycle diagram (Symbiotic_Thinking_3.png from the Alan folder): Self-Directed Learner, Integrative Solver, Adaptive Builder around Symbiotic Thinking. The capability names are in the picture, so there is no separate list.*

**Step label:** Toward two outcomes

**Outcome 1 name:** Superagency
**Outcome 1 question:** What problems are now within my reach that I would not have attempted before?

**Outcome 2 name:** Human value
**Outcome 2 question:** What would be worse about my solutions if I had simply handed the problem to AI?
...
**QR 1 caption:** Talk to the Sensei about this work
