...
- `slides/` — the house deck system for the fall courses (v1, 9 Sep 2026): slide register, structure, and the Pear Deck handoff. This is the current slides skill; the older `slides` in the team repo is deck-structure only.
